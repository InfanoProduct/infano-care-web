        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-4 text-center lg:text-left z-30">
            ...
            >
              ...
              <span className="text-[9px] font-bold text-slate-600 uppercase tracking-[0.2em]">The Leader in Girls' Wellness</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl md:text-5xl xl:text-5xl font-bold font-heading text-slate-900 mb-5 leading-[1.1] tracking-tight"
            >
              Build The Skills To <br />
              <span className="text-primary font-bold">Bloom With Confidence.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-sm md:text-base text-slate-500 mb-8 max-w-sm leading-relaxed font-medium mx-auto lg:mx-0"
            >
