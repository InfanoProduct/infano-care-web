        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-6">
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-7xl font-bold font-heading text-slate-900 mb-8 leading-[1.1] tracking-tight"
            >
            ...
            <motion.p 
              ...
              className="text-lg text-slate-500 mb-12 max-w-xl leading-relaxed font-medium"
            >
            ...
            >
              <Link href="/contact" className="btn-primary w-full sm:w-auto text-lg px-10 py-5 group shadow-2xl shadow-primary/20">
                Request Consultation <ArrowRight className="ml-2 transition-transform group-hover:translate-x-1" size={20} />
              </Link>
              <Link href="#" className="btn-outline w-full sm:w-auto text-lg px-10 py-5 border-slate-200 text-slate-700 hover:bg-slate-50">
                Partnership Guide
              </Link>
            </motion.div>
          </div>
