      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        <div>
          <Image
            ...
            width={500}
            height={500}
            className="absolute z-10 bottom-0 right-[48%] w-[600px]  object-contain "
          />
        </div>
        <div className="max-w-4xl mx-auto bg-white rounded-[4rem] p-12 md:p-20  shadow-[0_50px_100px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden border border-white/10">
