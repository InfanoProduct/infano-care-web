...
export function SuperpowerCard({ title, desc, features, image, link, index, priority }: SuperpowerCardProps & { priority?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-[0%] bottom-[-5%] w-[55%] h-[65%] transition-all duration-1000 group-hover:scale-110 group-hover:-rotate-3 origin-bottom-right">
