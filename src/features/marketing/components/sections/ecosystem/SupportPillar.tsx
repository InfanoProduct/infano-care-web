        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="flex items-center gap-6 mb-6">
              ...
              <h2 className="text-2xl md:text-4xl font-bold text-slate-900 tracking-tighter leading-none">Expert-Led <br /> Support Circles</h2>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              {[
                ...
                <div key={circle.name} className="bg-white border border-slate-100 p-6 rounded-[2.5rem] shadow-md hover:shadow-purple-900/5 transition-all group">
                  <h4 className="font-bold text-slate-900 mb-1 group-hover:text-purple-600 transition-colors text-base">{circle.name}</h4>
            ...
            <div className="bg-slate-900 text-white p-8 rounded-[3rem] shadow-xl relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-xl font-bold tracking-tight">Safe & Verified</h4>
              </div>
